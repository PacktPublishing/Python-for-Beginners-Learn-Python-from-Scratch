...
1000: 900 1100  randint(900, 1100)
4000: 3600 4400 randint(3600, 4400)
...
def findApproximateValue(initialValue, percentRange = 10):
    lowestValue = initialValue - (percentRange / 100) * initialValue
    highestValue = initialValue + (percentRange / 100) * initialValue
...
while gameLength > 0:
    ...
    if (playerAnswer == "yes"):
        ...
        if(drawnEvent == Event.Chest):
            ...
            playerReward = findApproximateValue(rewardsForChests[drawnColour])
